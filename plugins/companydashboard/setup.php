<?php
/**
 * Company Dashboard — plugin propio de la Plataforma GLPI Modular.
 *
 * Estrategia (Configure -> Existing -> Extend -> Integrate -> Build): Configure + Build
...
define('PLUGIN_COMPANYDASHBOARD_VERSION', '0.1.0');

// Rango de versiones de GLPI soportadas (obligatorio por CLAUDE.md).
define('PLUGIN_COMPANYDASHBOARD_GLPI_MIN_VERSION', '11.0');
define('PLUGIN_COMPANYDASHBOARD_GLPI_MAX_VERSION', '12.0');
 ...
 */
function plugin_init_companydashboard() {
    global $PLUGIN_HOOKS;

    // Cumplimiento CSRF exigido por GLPI para todo plugin.
    $PLUGIN_HOOKS['csrf_compliant']['companydashboard'] = true;
    ...
    //   $PLUGIN_HOOKS['menu_toadd']['companydashboard'] = [...];
    //   $PLUGIN_HOOKS['item_add']['companydashboard']   = [...];
}
 ...
 * @return array
 */
function plugin_version_companydashboard() {
    return [
        'name'         => 'Company Dashboard',
        'version'      => PLUGIN_COMPANYDASHBOARD_VERSION,
        'author'       => 'Plataforma Interna',
        'license'      => 'GPL-3.0-or-later',
        'homepage'     => '',
        'requirements' => [
            'glpi' => [
                'min' => PLUGIN_COMPANYDASHBOARD_GLPI_MIN_VERSION,
                'max' => PLUGIN_COMPANYDASHBOARD_GLPI_MAX_VERSION,
            ],
            'php'  => [
                'min' => '8.2',
            ],
 ...
 * @return boolean
 */
function plugin_companydashboard_check_prerequisites() {
 ...
 * @return boolean
 */
function plugin_companydashboard_check_config($verbose = false) {
    return true;
}
