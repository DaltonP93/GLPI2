<?php
/**
 * Company Portal — plugin propio de la Plataforma GLPI Modular.
 *
 * Estrategia (Configure -> Existing -> Extend -> Integrate -> Build): Extend
...
define('PLUGIN_COMPANYPORTAL_VERSION', '0.1.0');
...
define('PLUGIN_COMPANYPORTAL_GLPI_MIN_VERSION', '11.0');
define('PLUGIN_COMPANYPORTAL_GLPI_MAX_VERSION', '12.0');
 ...
 */
function plugin_init_companyportal() {
    global $PLUGIN_HOOKS;

    // Cumplimiento CSRF exigido por GLPI para todo plugin.
    $PLUGIN_HOOKS['csrf_compliant']['companyportal'] = true;
    ...
    //   $PLUGIN_HOOKS['menu_toadd']['companyportal'] = [...];
    //   $PLUGIN_HOOKS['item_add']['companyportal']   = [...];
}
 ...
 * @return array
 */
function plugin_version_companyportal() {
    return [
        'name'         => 'Company Portal',
        'version'      => PLUGIN_COMPANYPORTAL_VERSION,
        'author'       => 'Plataforma Interna',
        'license'      => 'GPL-3.0-or-later',
        'homepage'     => '',
        'requirements' => [
            'glpi' => [
                'min' => PLUGIN_COMPANYPORTAL_GLPI_MIN_VERSION,
                'max' => PLUGIN_COMPANYPORTAL_GLPI_MAX_VERSION,
            ],
            'php'  => [
                'min' => '8.2',
            ],
 ...
 * @return boolean
 */
function plugin_companyportal_check_prerequisites() {
 ...
 * @return boolean
 */
function plugin_companyportal_check_config($verbose = false) {
    return true;
}
