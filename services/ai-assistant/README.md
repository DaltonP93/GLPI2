...
- **Propósito:** Asistente IA (RAG) sobre fuentes autorizadas, con control de acceso (ACL), que cita la fuente interna y escala a una persona cuando no hay evidencia suficiente.
